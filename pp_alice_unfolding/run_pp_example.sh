...
python $PYJETTY_DIR/pyjetty/alice_analysis/process/user/kyle/process_data_ENC.py -c $PYJETTY_DIR/pyjetty/alice_analysis/process/user/kyle/process_pp_nominal.yaml -f $INFILE -o $OUTPUT_DIR