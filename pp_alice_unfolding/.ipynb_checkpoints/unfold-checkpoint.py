...
pt_hat = synth_df["pt_hat"].to_numpy()
...
# TODO get mc weights from pt hat min
pt_hat = pt_hat[hvd.rank():nevts:hvd.size()]
...
print(mc_gen)
print("HVD pt hat " + str(pt_hat.shape))
print(pt_hat)
