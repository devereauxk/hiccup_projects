...
OUTPUT_PREFIX="/global/cfs/cdirs/alice/kdevero/pp_alice_unfolding/AnalysisResults/$JOB_ID"
...
python $PYJETTY_DIR/pyjetty/alice_analysis/process/user/kyle/process_data_ENC.py -c $PYJETTY_DIR/pyjetty/alice_analysis/process/user/kyle/process_pp_nominal.yaml -f $INPUT_FILE -o $OUTPUT_DIR
