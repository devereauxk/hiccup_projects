...
python $PYJETTY_DIR/pyjetty/alice_analysis/process/user/kyle/process_mc_ENC.py -c $PYJETTY_DIR/pyjetty/alice_analysis/process/user/kyle/process_pp_nominal.yaml -f $INPUT_FILE -o $OUTPUT_DIR
