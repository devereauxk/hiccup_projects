...
python $PYJETTY_DIR/pyjetty/alice_analysis/process/user/kyle/process_mc_jet-trk.py -c $PYJETTY_DIR/pyjetty/alice_analysis/process/user/kyle/process_pp_emb.yaml -f $INPUT_FILE -o $OUTPUT_DIR
